...
from reels_api.analyzer import CLAUDE_MODELS, analyze_with_claude
from reels_api.audio_processor import AUDIO_EXTS, VIDEO_EXTS, prepare_audio
from reels_api.preview_media import preview_media_type, render_cut_previews
from reels_api.spreadsheet_generator import generate_spreadsheet
from reels_api.transcription import fmt_time, transcribe_audio
...
def _persist_job_artifacts(
    ...
    into generated_data/<job_id>/ under the backend directory. Runs before temp dir is removed.
    """
